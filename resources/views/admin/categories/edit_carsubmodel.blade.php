        ...
        <div class="box">
            ...
            <form action="{{ route('admin.categories.update', $category->id) }}" method="post" class="form" enctype="multipart/form-data" onsubmit="$('select').attr('disabled', false);">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="brand" id="brand" class="form-control" disabled="">
                            ...
                            @foreach($brands as $cat)
                                ...
                                <option @if($cat->id == $bid) selected="selected" @endif value="{{$cat->id}}">{{$cat->name}}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="parent" id="parent" class="form-control" disabled="">
                            ...
                            @foreach($carmodels as $cm)
                                ...
                                <option @if($cm->id == $mid) selected="selected" @endif value="{{$cm->id}}">{{$cm->name}}</option>
                    ...
                    <div class="form-group hide">
                        <input type="hidden" name="old_cover" value="{{$category->cover}}"/>
                ...
                <div class="box-footer">
                    ...
                    <div class="btn-group">
                        ...
                        <a href="{{ url('admin/categories/'.$category->parent_id.'?type=carsubmodel') }}" class="btn btn-default">Back</a>
