        ...
        @if($category)
            <div class="box">
                ...
                <hr>
                    <div class="box-body">
                        <h2>Car Models
                            <a style="float:right;" class="btn btn-success btn-sm" href="{{ url('admin/categories/create?type=carmodel&bid='.$category->id) }}"><i class="fa fa-plus"></i> Create Car Model</a>
                        </h2>
                        <table class="table1">
                            <thead>
                            <tr>
                                    ...
                                    @foreach($categories as $cat)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ url('admin/categories/'.$cat->id.'/edit?type=carmodel') }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                                <form action="{{ route('admin.categories.destroy', $cat->id) }}" method="post" class="form-horizontal" style="display: inline-block;">
                                                    {{ csrf_field() }}
                                                    <input type="hidden" name="_method" value="delete">
                                                    <input type="hidden" name="type" value="carmodel">
                                                    <input type="hidden" name="brandId" value="{{$category->id}}">
