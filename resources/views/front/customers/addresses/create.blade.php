        ...
        <div class="box">
            <form action="{{ route('customer.address.store', $customer->id) }}" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="zip">{{LanguageHelper::getPhrase('ad_zipcode')}} </label>
                ...
                <div class="box-footer">
                    <div class="btn-group">
                        <a href="{{ route('accounts', ['tab' => 'address']) }}" class="btn btn-default">{{LanguageHelper::getPhrase('ad_back')}}</a>
                        <button type="submit" class="btn btn-primary">{{LanguageHelper::getPhrase('ad_create')}}</button>
                    </div>
                </div>
            </form>
        </div>
