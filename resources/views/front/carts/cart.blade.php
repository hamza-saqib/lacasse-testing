            ...
            @if(!$cartItems->isEmpty())
                <div class="row">
                    <div class="col-md-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">{{ LanguageHelper::getPhrase('cart')}}</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 content">
                        ...
                        <h3><i class="fa fa-cart-plus"></i> {{ LanguageHelper::getPhrase('shopping_cart')}}</h3>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row hidden-xs hidden-sm" style="height: 40px;">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><b>{{ LanguageHelper::getPhrase('cart_cover')}}</b></div>
                                </div>
                            </div>

                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-8">
                                <div class="row">
                                    <div class="col-lg-5 col-md-5"><b>{{ LanguageHelper::getPhrase('cart_name')}}</b></div>
                                    <div class="col-lg-2 col-md-2"><b>{{ LanguageHelper::getPhrase('cart_quantity')}}</b></div>
                                    <div class="col-lg-1 col-md-1"><b>{{ LanguageHelper::getPhrase('cart_remove')}}</b></div>
                                    <div class="col-lg-2 col-md-2"><b>{{ LanguageHelper::getPhrase('cart_price')}}</b></div>
                                    <div class="col-lg-2 col-md-2"><b>{{ LanguageHelper::getPhrase('cart_total')}}</b></div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-9 col-xs-8">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-8">
                                            <form action="{{ route('cart.update', $cartItem->rowId) }}" class="form-inline" method="post">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-btn"><button class="btn btn-default btn-sm">{{ LanguageHelper::getPhrase('cart_update')}}</button></span>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                            <span class="hidden-lg hidden-md"><small>{{ LanguageHelper::getPhrase('cart_price')}}: </span>
                                            {{config('cart.currency')}} {{ number_format($cartItem->price, 2) }}</small>
                                        </div>
                                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                            <span class="hidden-lg hidden-md"><small>{{ LanguageHelper::getPhrase('cart_total')}}: </span>
                ...
                <div class="row">
                    <div class="col-md-12 content">
                        <table class="table table-striped">
                            <tfoot>
                                <tr>
                                    <td class="bg-warning">{{ LanguageHelper::getPhrase('cart_subtotal')}}</td>
                                ...
                                <tr>
                                    <td class="bg-warning">{{ LanguageHelper::getPhrase('cart_shipping')}}</td>
                                    <td class="bg-warning"></td>
                                    <td class="bg-warning"></td>
                                    <td class="bg-warning"></td>
                                ...
                                @endif
                                <tr>
                                    <td class="bg-warning">{{ LanguageHelper::getPhrase('cart_tax')}}</td>
                                    <td class="bg-warning"></td>
                                    <td class="bg-warning"></td>
                                    <td class="bg-warning"></td>
                                ...
                                <tr>
                                    <td class="bg-success">{{ LanguageHelper::getPhrase('cart_total')}}</td>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="btn-group pull-right">
                                    <a href="{{ route('home') }}" class="btn btn-default">{{ LanguageHelper::getPhrase('cart_continue_shopping')}}</a>
                                    <a href="{{ route('checkout.index') }}" class="btn btn-primary">{{ LanguageHelper::getPhrase('cart_goto_checkout')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
