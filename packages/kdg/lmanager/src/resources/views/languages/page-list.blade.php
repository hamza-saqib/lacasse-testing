			...
			<div class="panel panel-custom">
				<div class="panel-heading">
					...
					<div class="pull-right messages-buttons">
						...
						<a href="{{URL_LANGUAGE_PAGE_ADD}}" class="btn  btn-primary button helper_step1" >{{ LanguageHelper::getPhrase('create_page')}}</a>
...
@section('footer_scripts')
  	@include('lmanager::common.page-datatables', array('route'=>'languages.page_dataTable'))
 	@include('lmanager::common.deletescript', array('route'=>URL_LANGUAGE_PAGE_DELETE))
@stop