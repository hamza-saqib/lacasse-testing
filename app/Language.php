...
class Language extends Model
{
   ...
   public function addPhrase($phrase, $default_language = 0)
   {
      ...
      if( LanguageHelper::urlHasString('logout') || LanguageHelper::urlHasString('login'))
        return;
    ...
    */
  	public static function resetLanguage()
    {
        if(session()->has('user_lang')){
          ...
          $language = Language::where('code', '=', session()->get('user_lang'))->first();
