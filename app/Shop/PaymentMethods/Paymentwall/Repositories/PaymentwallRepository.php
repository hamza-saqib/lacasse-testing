...
class PaymentwallRepository implements PaymentwallRepositoryInterface
{
    /**
     * @var mixed
     */
     ...
     * @throws \Exception
     */
    public function execute(Request $request, $data, $customer, $billingAddress)
    {
        dd($data);
