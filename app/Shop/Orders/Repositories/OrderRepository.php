...

{
    ...
    public function listOrders(string $startDate = null, string $endDate = null, string $order = 'id', string $sort = 'desc', array $columns = ['*']) : Collection
    {
        return $this->model->when($startDate, function ($query) use ($startDate) {
    ...
    public function listOrdersByShop(int $shopId, string $startDate = null, string $endDate = null, string $order = 'id', string $sort = 'desc', array $columns = ['*']) : Collection
    {
        return $this->model->join('order_product', 'order_product.order_id', 'orders.id')
    ...
    public function associateProduct(Product $product, $quality = '', array $data = [])
...

    {
        ...
        return $this->model->products->map(function (Product $product) {
            ...
            $product->quality = $product->pivot->quality;
