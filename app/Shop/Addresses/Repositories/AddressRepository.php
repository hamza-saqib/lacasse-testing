...

{
    ...
    public function createAddress(array $data) : Address
    {
       //  print_r($data); die;
         ...
         $data['province_id'] = "1";
         $data['city_id'] = "1";
         $data = array('alias' => $data['alias'], 'address_1' => $data['address_1'] ,'address_2' => $data['address_2'] , 'zip' => $data['zip'] , 'country_id' => $data['country_id'] ,'status' =>$data['status'] ,'customer_id' => $data['customer_id'] ,'province_id'=>$data['province_id'] , 'city'=>$data['city_id'], 'phone'=>$data['phone']);
